      ...
      <div className="flex items-center gap-8 max-w-4xl w-full">
        ...
        <div className="hidden md:flex flex-1 items-center justify-center">
          <div className="relative w-full max-w-md">
            ...
            <div className="bg-gradient-to-br from-blue-600 via-purple-600 to-pink-600 rounded-3xl p-12 shadow-2xl">
              <div className="bg-gray-800 rounded-2xl p-8 text-center">
                ...
                <h2 className="text-2xl font-bold text-white mb-2">THEE MARTS SPACE</h2>
                <p className="text-gray-400 text-sm">Manage your workforce efficiently</p>
        ...
        {/* Right Side - Login Form (Instagram style) */}
          ...
          <div className="bg-gray-800 border border-gray-700 rounded-lg p-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              <input
                ...
                className="w-full px-3 py-2 text-sm bg-gray-700 border border-gray-600 rounded text-white placeholder-gray-400 focus:outline-none focus:border-gray-500"
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-semibold rounded transition disabled:opacity-50"
              >
